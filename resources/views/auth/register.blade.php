...
<div class="container">
    <div class="row justify-content-center">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+.[a-z]{2,}$" type="email" class="form-control @error('email') is-invalid @enderror" pattern="^([a-zA-Z0-9_\-\.]+)@([a-zA-Z0-9_\-\.]+)\.([a-zA-Z]{2,5})$"name="email" value="{{ old('email') }}" required autocomplete="email">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+.[a-z]{2,}$" type="email" class="form-control @error('email') is-invalid @enderror" name="ParentEmail" pattern="^([a-zA-Z0-9_\-\.]+)@([a-zA-Z0-9_\-\.]+)\.([a-zA-Z]{2,5})$"value="{{ old('email') }}" required autocomplete="email">
        ...
        <input type="radio" name="gender" id="Helicopter" value="Helicopter">
                                ...
                                <div class="g-recaptcha" data-sitekey="6LezIKQZAAAAAHlZTTjXrzDVqIdsLR7VEMaGrLpq" ></div>
<br>
<br>
...
<?php
                        ...
                        {
                         $secret_key = '6LezIKQZAAAAAJfNf4FNLB4rHeOwQTxlmxWiWT0R';
